...
function buildPrompt(batch) {
  ...
  return [
    ...
    "",
    "For each sentence, list OTHER orderings of exactly those pieces that are",
    "also natural, grammatical Mandarin AND carry the same meaning.",
    "",
    "Rules:",
    "- Use every piece exactly once. Never add, drop, split, merge or alter a piece.",
    "- Only list an ordering a native speaker would actually say.",
    "- Never list an ordering that changes who does what to whom.",
    "- MOST SENTENCES HAVE NO VALID ALTERNATIVE. An empty list is the expected answer;",
    "  do not invent one to be helpful.",
    "",
