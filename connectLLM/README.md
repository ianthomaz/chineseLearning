...
Índice do repo: [`../docs/01_readme.md`](../docs/01_readme.md) · Resumo LLM/RAG no site: [`../docs/04_llm_conteudo_rag.md`](../docs/04_llm_conteudo_rag.md) · Portas/deploy: [`../docs/03_operacao_e_deploy.md`](../docs/03_operacao_e_deploy.md).
...
**URL base da API (HTTPS vs Tailscale vs VM):** matriz em **ITCS/featureLLM** — **`docs/MANUAL_INTEGRACAO.md`** § 1.1. Em **`web/deploy/server.env`**, usa **`https://llm.webplace.cc`** (ou IP Tailscale do Mac) para o Node na VM **não** depender de `127.0.0.1`.
